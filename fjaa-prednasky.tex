...
$R$ se nazývá $\varepsilon$-uzavřená, pokud $ \delta (q,\varepsilon) \subseteq R$ pro každý stav $ q \in R$.
...
\quad$E_i=E_{i-1} \cup \lbrace \delta (q,\varepsilon) | q \in E_{i-1}\rbrace$
...
$y \neq \varepsilon$
\item
pro každé $i > 0$ platí, že $xy^iz \in L$
\end{enumerate}
\end{veta}
...
\begin{definice}
Mějm KDA $A = \langle \Sigma, Q, \delta, q_{0}, F \rangle$ a zprava invariantní ekvivalenci $\Theta$ vzhledem k
