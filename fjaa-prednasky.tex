%%%% Martin Rotter, Jiří Zehnula - FJAA (zápisky z přednášek)
%%%%
...
\docinfo{Martin Rotter, Jiří Zehnula}{KMI/FJAA  -- Formální jazyky a automaty}
...
$$
\langle q,w,z \rangle = \langle q,ax,z \rangle \vdash \langle r_0,x,z_1z_2\cdots z_k \rangle \vdash^* \langle r_1,w_2 \cdots w_k,z_2 \cdots z_k \rangle \vdash^* \cdots \vdash^* \langle r_k,\varepsilon,\varepsilon \rangle = \langle p, \varepsilon, \varepsilon \rangle
$$
