...
$\underline{Počátek činnosti:}$ Vstup = celý vstupní řetězec. Řídící jednotka je v počátečním (iniciálním) stavu.
$\underline{Činnost automatu:}$ Na základě prvního symbolu na vstupu a na základě aktuálního stavu se řídící jednotka 
přepne do jiného stavu a odebere vstupní symbol.\\
$\underline{Konec činnosti:}$ Byl přečten celý vstupní řetězec. Podle toho v jaké končí automat stavu říkáme, 
