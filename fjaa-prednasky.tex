...
\end{veta}
 ...
 $ \delta^{S^*} (E_A(R),w) = \delta^{S^*} (E_A(R),av) = \delta^{S^*} (\bigcup_{q \in E_A(R)} \delta^S(q,a), u) = \delta^{S^*} (\bigcup_{q \in E_A(R)} E_A(\bigcup_{u \in E_A(\lbrace q \rbrace)} \delta (u,a)),u) = $
 
 %%%% DOPLNIT, ZBYTEK DUKAZU mi CHYBI %%%
